...
@section('main')
 ...
 <form class="row g-3" action="{{route('customer.create')}}" method="POST">
    ...
    <div class="col-12">
      ...
      <input type="text" class="form-control" name="phone" id="inputAddres5s" placeholder="customer phone">
    </div>
    <div class="col-12">
      <label for="inputAddress2" class="form-label">facebook page</label>
      <input type="text" class="form-control" name="facebook" id="inputAddress2" placeholder="customer facebook page">
    </div>
    {{-- <div class="col-md-6">
